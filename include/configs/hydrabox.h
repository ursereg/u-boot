 ...
 *
 * Configuration settings for the hydrabox boards, based on 
 * Digi ConnecCore 6UL Starter board.
 *
 * SPDX-License-Identifier:	GPL-2.0+
 */
#ifndef HYDRABOX_CONFIG_H
#define HYDRABOX_CONFIG_H

#include "ccimx6ul_common.h"

#define CONFIG_BOARD_DESCRIPTION	"Hydrabox"
